...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final energyData = provider.currentReport;
    ...
    return Scaffold(
      ...
      body: _buildBody(provider, energyData),
    );
  }

  Widget _buildBody(EnergyProvider provider, EnergyReportData? energyData) {
...
// ---------------------------------------------------------------------------
  ...
  /// Builds the pie chart and legend using live backend entries.
